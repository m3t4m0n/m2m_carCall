...
public class RecyclerCardViewTab extends RecyclerView.Adapter <RecyclerCardViewTab.ViewHolder> {

    private ArrayList<CarReservReqListActivity.ReqItem> mDataset;
    ...
    public RecyclerCardViewTab(ArrayList<CarReservReqListActivity.ReqItem> carReqList) {
        mDataset = carReqList;
    }

    @Override
    public RecyclerCardViewTab.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.content_car_tab_cardview, parent, false);
